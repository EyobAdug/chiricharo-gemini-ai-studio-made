        ...
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleMfaSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={mfaLoading}
              className="w-full rounded-full bg-emerald-700 py-4 text-base font-bold text-white hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-100 disabled:opacity-50 active:scale-[0.98]"
            >
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                disabled={mfaLoading}
                className="w-full text-sm font-bold text-emerald-700 hover:text-emerald-800 transition-all disabled:opacity-50"
              >
